        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl space-y-6 md:space-y-8">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
              Shipbox provides secure, isolated, and persistent Cloudflare
              sandboxes for AI agents. Give your agents a real environment to
              code, test, and deploy—without the infra overhead.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
              <Button
                ...
                className="h-16 px-10 text-lg gap-3 w-full sm:w-auto"
              >
                Get Started
              ...
              <Button
                variant="outline"
                size="lg"
                className="h-16 px-10 text-lg border-white/10 hover:bg-white/5 w-full sm:w-auto"
                onClick={() => window.open("https://docs.shipbox.dev")}
              >
                Read Documentation
              </Button>
            </div>
            ...
            <div className="p-8 rounded-[2.5rem] border border-white/5 bg-white/5 space-y-6 hover:border-primary/20 transition-colors group">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Every agent gets a dedicated Cloudflare container with a full
                  Linux-like environment and persistent storage.
                </p>
              </div>
            </div>
            <div className="p-8 rounded-[2.5rem] border border-white/5 bg-white/5 space-y-6 hover:border-primary/20 transition-colors group">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Native support for Model Context Protocol. Use Shipbox as a
                  tool for Claude, ChatGPT, or your own custom agents.
                </p>
              </div>
            </div>
            <div className="p-8 rounded-[2.5rem] border border-white/5 bg-white/5 space-y-6 hover:border-primary/20 transition-colors group">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Internal API keys and GitHub tokens are injected via a secure
                  proxy. Credentials never live inside the sandbox.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 text-center space-y-12">
          <div className="max-w-2xl mx-auto space-y-4">
            ...
            <p className="text-muted-foreground text-lg">
              No monthly subscriptions. Pay only for the compute and tokens your
              agents actually use. Top up whenever you need.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 max-w-4xl mx-auto gap-8 text-left">
              ...
              <div className="space-y-2 relative z-10">
                ...
                <ul className="space-y-3 pt-6">
                  <li className="flex items-center gap-3 text-sm font-medium">
                    <Play className="w-4 h-4 text-primary" /> 1 Credit = 1
                    Minute Sandbox Uptime
                  </li>
                  <li className="flex items-center gap-3 text-sm font-medium">
                    <Play className="w-4 h-4 text-primary" /> Variable AI Token
                    Pricing
                  </li>
                  <li className="flex items-center gap-3 text-sm font-medium">
                    <Play className="w-4 h-4 text-primary" /> 100 Free Starter
                    Credits
                  </li>
                </ul>
              </div>
            ...
            <div className="p-10 rounded-[3rem] border border-primary/20 bg-primary/5 space-y-6 relative overflow-hidden">
              <div className="space-y-2 relative z-10">
                ...
                <ul className="space-y-3 pt-6">
                  <li className="flex items-center gap-3 text-sm font-medium">
                    <Play className="w-4 h-4 text-primary" /> Use your own
                    Anthropic API Key
                  </li>
                  <li className="flex items-center gap-3 text-sm font-medium">
                    <Play className="w-4 h-4 text-primary" /> Only pay for
                    sandbox compute
                  </li>
                  <li className="flex items-center gap-3 text-sm font-medium">
                    <Play className="w-4 h-4 text-primary" /> Custom rate limits
                    and models
                  </li>
                </ul>
              </div>
          ...
          <div className="pt-8">
            <Button
              size="lg"
              onClick={onGetStarted}
              className="h-16 px-10 text-lg gap-3"
            >
      ...
      <footer className="py-20 border-t border-white/5 bg-slate-950">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-black uppercase tracking-tighter opacity-40">
              Shipbox
            </span>
          </div>
          ...
          <div className="flex gap-8">
            <a
              href="#"
              className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/40 hover:text-white transition-colors"
            >
              Privacy
            </a>
            <a
