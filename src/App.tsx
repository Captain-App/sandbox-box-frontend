...
function App() {
  ...
  const [balance, setBalance] = useState<{ balanceCredits: number } | null>(
    null,
  );
  ...
  const handleOpenBox = (sandbox?: Sandbox) => {
    const target = sandbox || activeSandbox;
    if (target) {
      navigate(`/box/${target.sessionId || target.id}`);
    }
  };
        ...
        element={
          ...
          >
            <div className="space-y-8">
              {loading ? (
                <div className="flex items-center justify-center py-20" data-testid="app-loading">
                  <Loader2 className="w-8 h-8 text-primary animate-spin" />
                </div>
              ) : (
                <Routes>
                        ...
                        <div className="p-6 md:p-12 rounded-3xl border border-white/5 bg-white/5 text-center space-y-6">
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-sm md:text-base text-muted-foreground">
                              You haven't created any agent environments yet.
                            </p>
                          </div>
                          <Button
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                          <div className="p-6 md:p-8 rounded-3xl border border-white/5 bg-white/5 backdrop-blur-xl lg:col-span-2 relative overflow-hidden">
                            <div className="relative z-10">
                              ...
                              <p className="text-sm text-muted-foreground">
                                Persistent agent box initialized on{" "}
                                {new Date(
                                  activeSandbox.createdAt,
                                ).toLocaleDateString()}
                                .
                              </p>
                              ...
                              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                                <div className="flex-1 p-4 rounded-2xl bg-white/5 border border-white/5">
                                  ...
                                  <div className="text-2xl font-black">
                                    {activeSandbox.tasksCompleted || 0}
                                  </div>
                                </div>
                                <div className="flex-1 p-4 rounded-2xl bg-white/5 border border-white/5">
                                  <div className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-1">
                                  ...
                                  <div className="text-2xl font-black">
                                    {activeSandbox.memoryUsage || "0.1 GB"}
                                  </div>
                                </div>
                              </div>
                                  ...
                                  <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                      ...
                                      <div className="text-xs text-muted-foreground">
                                        Enable power tools to give your agent full
                                        capability.
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <div className="mt-8 p-4 md:p-6 rounded-2xl bg-green-500/10 border border-green-500/20 flex items-center gap-4">
                                  ...
                                  <div>
                                    ...
                                    <div className="text-xs text-green-500/80">
                                      Agent operating with full system privileges.
                                    </div>
                                  </div>
                                </div>
                              )}
                          ...
                          <div className="p-8 rounded-3xl border border-white/5 bg-primary/10 flex flex-col justify-center items-center text-center">
                            ...
                            <span className="text-4xl md:text-5xl font-black tracking-tighter">
                              £
                              {((balance?.balanceCredits || 0) / 100).toFixed(2)}
                            </span>
                            <button
                  ...
                  <Route
                    path="/boxes"
                    element={
                      <div className="space-y-6 md:space-y-8" data-testid="boxes-page">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                          <div className="space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                              Manage your agent instances and environment
                              configuration.
                            </p>
                          </div>
                          <Button
                        ...
                        <div className="grid grid-cols-1 gap-4">
                          {sandboxes.length === 0 ? (
                            ...
                            sandboxes.map((sb) => (
                              <div
                                key={sb.id}
                                className="p-4 md:p-6 rounded-3xl border border-white/5 bg-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-6 group hover:bg-white/10 transition-all"
                              >
