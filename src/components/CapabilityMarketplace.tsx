...
const capabilities: Capability[] = [
  {
    ...
    name: "RepoSwarm",
    description:
      "Continuously regenerates AI-readable architecture knowledge from source code across multiple repositories.",
    icon: Code,
    price: "Free",
    isInstalled: true,
  ...
  },
  {
    ...
    description:
      "Automated monitoring of competitor pricing pages and feature releases with daily summaries.",
    icon: Globe,
    price: "£5/mo",
    isInstalled: false,
  ...
  },
  {
    ...
    description:
      "Enable voice-to-voice interaction with your agent using ultra-low latency xAI Realtime API.",
    icon: MessageSquare,
    price: "£10/mo",
    isInstalled: false,
    category: "Interface",
  },
  {
    ...
    description:
      "Connects to your bank and accounting API to automatically reconcile invoices and payments.",
    icon: Sparkles,
    price: "Free",
    isInstalled: false,
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">
            Pre-built skills and toolchains to extend your agent's powers.
          </p>
        </div>
