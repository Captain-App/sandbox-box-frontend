...
export function SecretsVault() {
  ...
  const handleRevokeAll = async () => {
    if (
      !confirm(
        "Are you sure you want to revoke ALL secrets? This cannot be undone.",
      )
    )
      return;
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">
            Managed credentials with automatic proxy redaction.
          </p>
        </div>
      ...
      <div className="p-6 rounded-3xl bg-blue-500/5 border border-blue-500/20 flex items-center gap-4">
        ...
        <p className="text-sm text-blue-200/80">
          Your credentials never enter the sandbox directly. The agent uses
          short-lived tokens proxied through our secure gateway.
        </p>
      </div>
      ...
      {isAdding && (
        <form
          ...
          className="p-8 rounded-[2rem] border border-primary/20 bg-primary/5 space-y-6 animate-in fade-in slide-in-from-top-4 duration-300"
        >
              ...
              <div className="flex items-center gap-8">
                <div className="text-right">
                  ...
                  <div className="text-xs font-medium">
                    {formatLastUsed(secret.lastUsed)}
                  </div>
                </div>
                <button
