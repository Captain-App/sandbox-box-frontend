...
describe('Settings Component', () => {
  ...
  it('renders settings and github status when loaded', async () => {
    mockedApi.getSettings.mockResolvedValue(settingsFactory({ anthropicHint: '***1234' }))
    mockedApi.getGitHubStatus.mockResolvedValue(githubStatusFactory({ accountLogin: 'crew', accountType: 'User' }))
  ...
  it('shows "Connect GitHub" when not connected', async () => {
    mockedApi.getSettings.mockResolvedValue(settingsFactory({ anthropicHint: null }))
