        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="p-8 rounded-3xl border border-white/5 bg-slate-900/50 backdrop-blur-xl relative overflow-hidden">
            ...
            <div className="space-y-4">
              <EventRow
                type="usage"
                title="Session usage tracked"
                detail="user_2p... consumed 42 credits"
                time="2m ago"
              />
              <EventRow
                type="topup"
                title="Credit top-up"
                detail="user_9x... added £10.00"
                time="15m ago"
              />
              <EventRow
                type="session"
                title="New session created"
                detail="user_1a... started sandbox-v4"
                time="22m ago"
              />
              <EventRow
                type="error"
                title="Session launch failed"
                detail="Region 'us-east-1' at capacity"
                time="1h ago"
              />
            </div>
            <div className="mt-8">
          ...
          <div className="p-8 rounded-3xl border border-white/5 bg-slate-900/50 backdrop-blur-xl">
            ...
            <div className="space-y-3">
              <SupportLink
                ...
                title="User Lookup"
                description="Find account by ID or email"
              />
              <SupportLink
                icon={<Activity className="w-4 h-4" />}
                title="Error Monitor"
                description="Real-time Sentry issues"
              />
              <SupportLink
                icon={<ExternalLink className="w-4 h-4" />}
                title="Stripe Dashboard"
                description="Manage payments directly"
              />
              <SupportLink
