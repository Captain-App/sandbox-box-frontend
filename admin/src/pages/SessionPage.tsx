...
export function SessionPage() {
  ...
  const [activeTab, setActiveTab] = useState<"logs" | "metadata" | "files">(
    "logs",
  );
  ...
  if (!metadata)
    return (
      <div className="py-20 text-center text-red-500">Session Not Found</div>
    );
          ...
          <div className="h-full border border-white/5 bg-slate-900/50 rounded-3xl flex items-center justify-center p-8 text-center">
            <div className="max-w-md space-y-4">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                For security reasons, direct file system browsing is only
                available via the session debugger. Full environment snapshots
                can be requested for forensics.
              </p>
